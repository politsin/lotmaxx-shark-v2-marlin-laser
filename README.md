...
4. [Разъём WIFI](docs/WIFI.md) - питание, наблюдаемые дорожки и план безопасной прозвонки.
5. [Лазерная часть](docs/LASER.md) - разъёмы, сигналы и оставшиеся неизвестные.
6. [Драйвер SC-60-V2-L-V1.0](docs/LASER_DRIVER.md) - фото, элементы, питание и план завершения схемы.
7. [Сборка Marlin](docs/MARLIN.md) - что менять и как получить `SM3DP.bin`.
8. [LightBurn](docs/LIGHTBURN.md) - профиль, G-code и команды проверки.
9. [DWIN](docs/DWIN.md) - что оставить штатным и почему.
