...
**Итог на текущем этапе:** из 100 физических ножек у **77** зафиксировано назначение Beta M либо системная функция питания/тактирования; у **23** назначение платы пока не установлено. Неподтверждённые номера: `1`, `15`, `23`, `24`, `59`, `67-69`, `82-90`, `92`, `93`, `95-98`.
